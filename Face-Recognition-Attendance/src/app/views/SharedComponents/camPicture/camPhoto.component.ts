...
@Component({
    selector: 'app-camPhoto',
    styleUrls: ['./camPhoto.component.scss'],
    templateUrl: './camPhoto.component.html',
})
    ...
    initializeUploader() {
        ...
        this.uploader.onSuccessItem = (item, response, status, headers) => {
          if (response) {
            ...
            if(!this.student2.photos.some(x=> x.id === photo.id)){
                this.student2.photos.push(photo);
            } 

            if(this.student.photos.length >=3){
                this.student.confirmed = true;
                this.student2.confirmed = true;
            }
